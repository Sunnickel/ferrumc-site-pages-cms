          ...
          <header className="h-16">
            <div className="mx-auto max-w-[1100px] px-5 h-full grid grid-cols-[auto_1fr_auto] items-center gap-4 relative">
              ...
              <nav className="hidden md:flex justify-start gap-3 ml-2 text-sm text-neutral-400">
                ...
                <a href="https://docs.ferrumc.com/" target='_blank' rel="noreferrer"
                   className="hover:text-white transition-colors flex gap-2">Documentation</a>
              </nav>

              <a className="hidden sm:inline-flex items-center rounded-lg bg-white/10 px-4 py-2 font-semibold hover:bg-white/15 justify-self-end transition-colors"

...
import GridBG from "@/components/background/grid";
                    ...
                    <div className="absolute inset-0">
                      ...
                      {roadmapData.map((item, index) => (
                              ...
                              >
                                ...
                                >
                                  {/* Status Badge */}
                                  <div className={`absolute -top-2 -right-2 px-2 py-0.5 sm:py-1 rounded-full text-xs font-bold bg-gradient-to-r ${statusColors[item.status]} text-white shadow-lg`}>

  ...
  return (
          <div className="flex flex-col min-h-screen">
            ...
            <main>
              {/* Hero Section */}
              <section
                      className="pt-12 pb-8  flex items-center relative overflow-hidden bg-[radial-gradient(80%_60%_at_10%_-10%,rgba(234,88,12,0.15),transparent_60%),radial-gradient(80%_60%_at_100%_0%,rgba(234,88,12,0.12),transparent_60%)] before:content-[''] before:absolute before:inset-0 before:pointer-events-none before:bg-[linear-gradient(rgba(255,255,255,0.06)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.04)_1px,transparent_1px)] before:bg-[length:24px_24px] before:[mask-image:radial-gradient(60%_60%_at_50%_0%,black,transparent_70%)]"
              >
                <div className="mx-auto max-w-[1100px] px-5 text-center">
                  ...
                  <p className="text-neutral-400 text-lg md:text-xl mt-6 mb-8 max-w-2xl mx-auto">
                    We&#39;re crafting something special for you! Our blog is currently being built
                    and will be launching soon with exciting content about FerrumC, Rust, and

      ...
      <main className="mx-auto max-w-[800px] px-5 py-16">
        ...
        <section className="mb-12">
          ...
          <p className="text-neutral-400 mb-4">
            By accessing our website or downloading and using FerrumC software, you agree to be bound by these Terms of
        ...
        <section className="mb-12">
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-6 mb-4">
            <p className="text-neutral-300 mb-4">
              ...
              <strong className="text-white">&#34;AS AVAILABLE&#34;</strong> without any warranties of any kind, either
              express or implied.
            </p>
            <p className="text-neutral-300">
              We do not warrant that the software will be error-free, secure, or uninterrupted. Use at your own risk.
            </p>
          </div>
          <p className="text-neutral-400">
        ...
        <section className="mb-12">
          ...
          <p className="text-neutral-400 mb-4">
            ...
            <strong className="text-white">not affiliated with, endorsed by, or associated with</strong> Mojang Studios,
            Microsoft Corporation, or any of their subsidiaries.
          </p>
          <p className="text-neutral-400 mb-6">
            &#34;Minecraft&#34; is a trademark of Mojang Synergies AB. All rights to the Minecraft brand, assets, and
        ...
        <section className="mb-12">
          ...
          <p className="text-neutral-400 mb-4">If you operate a FerrumC server, you are responsible for:</p>
          <ul className="list-disc pl-5 text-neutral-400 space-y-2 mb-6">
          ...
          <p className="text-neutral-400">
            You retain ownership of any content you create using FerrumC. However, you are solely responsible for any
            content created, hosted, or distributed through your server.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-neutral-400 mb-6">
            FerrumC is actively developed, but we make no guarantees about update frequency or ongoing support. The
            software may be modified or discontinued at any time.
          </p>

          <h3 className="text-xl font-semibold mb-3">Community Support</h3>
          <p className="text-neutral-400 mb-4">
            Support is provided on a best-effort basis by the community. We do not guarantee responses or solutions to
            any issues.
          </p>
          <p className="text-neutral-400">
        ...
        <section className="mb-12">
          ...
          <p className="text-neutral-400">
            Any disputes shall be resolved through good faith negotiation or, if necessary, in the appropriate courts.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-neutral-400 mb-4">
            We may revise these Terms of Service at any time. Changes will be posted on this page with an updated
            &#34;Last updated&#34; date.
          </p>
          <p className="text-neutral-400">

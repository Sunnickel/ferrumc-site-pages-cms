            ...
            <main className="mx-auto max-w-[800px] px-5 py-16">
              ...
              <section className="mb-12">
                ...
                <p className="text-neutral-400 mb-4">
                  FerrumC (&#34;we&#34;, &#34;us&#34;, or &#34;our&#34;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website or use our software.
                </p>
              ...
              <section className="mb-12">
                ...
                <ul className="list-disc pl-5 text-neutral-400 space-y-2 mb-6">
                  <li><strong className="text-white">Log data</strong> - IP address, browser type, pages visited, time spent on pages</li>
                  <li><strong className="text-white">Cookies</strong> - Small data files stored on your device to improve user experience</li>
                  <li><strong className="text-white">Analytics data</strong> - Anonymous usage statistics to improve our website</li>
                </ul>

                <h3 className="text-xl font-semibold mb-3">FerrumC Server Software</h3>
                <p className="text-neutral-400 mb-4">
                  The FerrumC server software itself does not collect or transmit any personal information. All data remains on your server.
                </p>
              ...
              <section className="mb-12">
                ...
                <ul className="list-disc pl-5 text-neutral-400 space-y-2 mb-6">
                  <li><strong className="text-white">GitHub</strong> - For hosting our repository and issue tracking</li>
                  <li><strong className="text-white">Discord</strong> - For community chat (if you join our server)</li>
                  <li><strong className="text-white">Analytics providers</strong> - For website usage statistics</li>
                </ul>
                <p className="text-neutral-400">
              ...
              <section className="mb-12">
                ...
                <ul className="list-disc pl-5 text-neutral-400 space-y-2">
                  ...
                  <li><strong className="text-white">Opt-out</strong> - Opt out of certain data collection practices</li>
                </ul>
              </section>
              ...
              <section className="mb-12">
                ...
                <p className="text-neutral-400">
                  FerrumC does not knowingly collect personal information from children under 13. If you believe we have collected information from a child, please contact us immediately.
                </p>
              </section>
